...
public class LoggedInActivity extends Activity {
    ...
    private CharSequence mDrawerTitle = "Google Plus Mini";
    private CharSequence mTitle = "Google Plus Mini";
       ...
       mDrawerLayout.setDrawerShadow(R.drawable.drawer_shadow, GravityCompat.START);
        ...
        if (savedInstanceState == null) {
            getFragmentManager().beginTransaction()
                    .add(R.id.container, new PeopleFragment(),null)
                    .commit();
        }
    }
    ...
    if(position == 0){
        ...
        CharSequence text = "Hello position 0!";
